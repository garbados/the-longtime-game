...
var G__2559 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__2559,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__2561__i = 0, G__2561__a = new Array(arguments.length -  0);
while (G__2561__i < G__2561__a.length) {G__2561__a[G__2561__i] = arguments[G__2561__i + 0]; ++G__2561__i;}
  args = new cljs.core.IndexedSeq(G__2561__a,0,null);
} 
return G__2560__delegate.call(this,args);};
G__2560.cljs$lang$maxFixedArity = 0;
G__2560.cljs$lang$applyTo = (function (arglist__2562){
var args = cljs.core.seq(arglist__2562);
return G__2560__delegate(args);
});
G__2560.cljs$core$IFn$_invoke$arity$variadic = G__2560__delegate;
return G__2560;
})()
;
} else {
...
var G__2563 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__2563,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__2564__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__2564 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__2565__i = 0, G__2565__a = new Array(arguments.length -  0);
while (G__2565__i < G__2565__a.length) {G__2565__a[G__2565__i] = arguments[G__2565__i + 0]; ++G__2565__i;}
  args = new cljs.core.IndexedSeq(G__2565__a,0,null);
} 
return G__2564__delegate.call(this,args);};
G__2564.cljs$lang$maxFixedArity = 0;
G__2564.cljs$lang$applyTo = (function (arglist__2566){
var args = cljs.core.seq(arglist__2566);
return G__2564__delegate(args);
});
G__2564.cljs$core$IFn$_invoke$arity$variadic = G__2564__delegate;
return G__2564;
})()
;
} else {
...
var G__2567 = props;
var G__2567__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__2567,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__2567);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__2567__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__2568 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__2568,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__2568;
}
})(),id_class);
...
var G__2569 = (cljs.core.count.call(null,argv) - first_child);
switch (G__2569) {
case (0):
...
var vec__2571 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__2571,(0),null);
var id = cljs.core.nth.call(null,vec__2571,(1),null);
var className = cljs.core.nth.call(null,vec__2571,(2),null);
...
var temp__5808__auto___2574 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___2574 == null)){
} else {
var key_2575 = temp__5808__auto___2574;
(jsprops.key = key_2575);
}
...
var temp__5808__auto___2576 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___2576 == null)){
} else {
var key_2577 = temp__5808__auto___2576;
(jsprops.key = key_2577);
}
...
var temp__5808__auto___2578 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___2578 == null)){
} else {
var key_2579 = temp__5808__auto___2578;
(jsprops.key = key_2579);
}
...
var temp__5808__auto___2580 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___2580 == null)){
} else {
var key_2581 = temp__5808__auto___2580;
(jsprops.key = key_2581);
}
...
var temp__5808__auto___2582 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___2582 == null)){
} else {
var key_2583 = temp__5808__auto___2582;
(jsprops.key = key_2583);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__2584_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__2584_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__2585 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__2585,(0),null);
var derefed = cljs.core.nth.call(null,vec__2585,(1),null);
...
break;
default:
var G__2590 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__2591 = compiler;
v = G__2590;
compiler = G__2591;
continue;
...
var G__2592 = tag;
var G__2592__$1 = (((G__2592 instanceof cljs.core.Keyword))?G__2592.fqn:null);
switch (G__2592__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template2595 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template2595 = (function (opts,id,fn_to_element,parse_fn,meta2596){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template2595.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_2597,meta2596__$1){
var self__ = this;
var _2597__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template2595(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta2596__$1));
}));

(reagent.impl.template.t_reagent$impl$template2595.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_2597){
var self__ = this;
var _2597__$1 = this;
return self__.meta2596;
}));

(reagent.impl.template.t_reagent$impl$template2595.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template2595.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template2595.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template2595.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template2595.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template2595.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta2596","meta2596",-1466649394,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template2595.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template2595.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template2595");

(reagent.impl.template.t_reagent$impl$template2595.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write.call(null,writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template2595");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template2595.
 */
reagent.impl.template.__GT_t_reagent$impl$template2595 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template2595(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta2596){
return (new reagent.impl.template.t_reagent$impl$template2595(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta2596));
});

}

return (new reagent.impl.template.t_reagent$impl$template2595(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
